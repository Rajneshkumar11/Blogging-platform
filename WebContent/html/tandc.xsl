...
<head>
	   <link rel = "stylesheet" href= '../Css/back.css'></link>
...
<body background="bck1.jpg">
	...
	<article class="about">
   		<p style=" font-size: 40px; text-style: bold ;" ><xsl:value-of select="tandc/heading/topic"/></p>
		<xsl:for-each select="tandc/termandcond">
			<p class="heading"><xsl:value-of select="topic"/> </p><br></br>
			<p class="context"> <xsl:value-of select="subtopic"/></p><br></br>
		</xsl:for-each>
	</article>
	<footer >
